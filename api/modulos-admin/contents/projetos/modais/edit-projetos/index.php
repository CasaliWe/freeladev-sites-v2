    ...
    <div class="modal-content">
      ...
      <form action="<?= $base_url ?>modulos-admin/contents/projetos/php/editar-projeto.php" method="post" enctype="multipart/form-data">
          ...
          <input type="hidden" id="id-projeto-editar" name="id-projeto-editar">
            ...
            <div class='mb-3'>
              <label class="small" for='categoria-projeto-editar'>Categoria do projeto*</label>
              <input type='text' id='categoria-projeto-editar' name='categoria-projeto-editar' class='form-control' required>
            </div>
