    ...
    <div class="modal-content">
      ...
      <form action="<?= $base_url ?>modulos-admin/contents/projetos/php/salvar-projeto.php" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class='mb-3'>
              <label class="small" for='categoria-projeto'>Categoria do projeto*</label>
              <input type='text' id='categoria-projeto' name='categoria-projeto' class='form-control' required>
            </div>
