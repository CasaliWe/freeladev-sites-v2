...
$categoria = filter_input(INPUT_POST, 'categoria-projeto', FILTER_SANITIZE_SPECIAL_CHARS);
...
if (isset($_FILES['img-projeto']) && $_FILES['img-projeto']['error'] != UPLOAD_ERR_NO_FILE) {
    ...
    $res = ProjetosRepository::create($titulo, $descri, $link, $categoria, $nomeArquivo);
    if ($res) {
