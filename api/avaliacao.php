...
<body>
    ...
    <main id="content-pagina">
        ...
        <?php include_once 'modulos-admin/contents/avaliacoes/index.php';?>
        <!-- módulo content página -->
    </main>
    <!-- CONTENT -->
    ...
    <!-- MODAL ADD AVALIAÇÕES -->
    <?php include_once "modulos-admin/contents/avaliacoes/modais/add-avaliacao/index.php"; ?>
    <!-- MODAL ADD AVALIAÇÕES -->
