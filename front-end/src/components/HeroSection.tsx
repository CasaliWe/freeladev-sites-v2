        ...
        <div className="flex flex-col md:flex-row items-center gap-12 pt-10 md:pt-0">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <AnimacaoScroll atraso="delay-200">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              </div>                <div className="mt-6 text-white/60 text-sm flex flex-col gap-2">
                ...
                <Link to="/briefing" className="inline-flex items-center gap-1 hover:text-laranja transition-colors">
                  Preencha nosso briefing para iniciar seu projeto
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="m9 18 6-6-6-6"/>
                  </svg>
                </Link>
